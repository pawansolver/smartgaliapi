...
import * as societyHardening from './migrations/013-enterprise-society-hardening.js';

const MIGRATIONS_TABLE = 'schema_migrations';
const migrations = [
  { ...societyHardening, version: '013-enterprise-society-hardening' },
];
...
run()
  .catch((error) => {
    console.error('Society migration failed:', error);
    process.exitCode = 1;
  })
