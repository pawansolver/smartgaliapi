...
import { requireAppAdmin } from '../../middleware/chatAuthorization.middleware.js';
 ...
 */
router.post('/', authenticate, requireAppAdmin, uploadImage('communityCategory').single('communityCategoryIcon'), communityCategoryController.createCommunityCategory);
 ...
 *         description: Community Category not found
 */
router.put('/:id', authenticate, requireAppAdmin, uploadImage('communityCategory').single('communityCategoryIcon'), communityCategoryController.updateCommunityCategory);
 ...
 *         description: Community Category not found
 */
router.delete('/:id', authenticate, requireAppAdmin, communityCategoryController.deleteCommunityCategory);
